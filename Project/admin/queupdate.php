...
<form name="form1" method="post" onSubmit="return check();">
 ...
 <tr>
        <td height="26"><div align="left"><strong> Enter Skill </strong></div></td>
        <td>&nbsp;</td>
