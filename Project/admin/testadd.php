...
echo "<h2 class='text-center bg-primary'>ADD MILESTONE</h2>";
...
echo "<p align=center>Test <b>\"$MILESTONE\"</b> Added Successfully.</p>";
unset($_POST);
}
?>
<SCRIPT LANGUAGE="JavaScript">
function check() {
mt=document.form1.Milestone.value;
if (mt.length<1) {
...
if(tt.length<1) {
alert("Please Enter What Most Children Do At This Age");
...
<form name="form1" method="post" onSubmit="return check();">
  <table class="table table-striped">>
    <tr>
      <td width="49%" height="32"><div align="left"><strong>Enter Age </strong></div></td>
      <td width="3%" height="5">  
...
?>
    ...
    <tr>
        <td height="26"><div align="left"><strong> Enter Milestone </strong></div></td>
        <td>&nbsp;</td>
	  <td><input class="form-control" name="testname" type="text" id="testname"></td>
    </tr>
    <tr>
      <td height="26"><div align="left"><strong>Enter Number of Skills </strong></div></td>
      <td>&nbsp;</td>
