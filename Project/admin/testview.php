...
$sql=mysqli_query($con,"select * from mst_test");	
	...
	echo"<tr><th><a class='btn btn-danger' href=\"testadd.php\"> ADD AGE</a>&emsp;&emsp;</th></tr>";
	echo "<tr><th class='text-primary'>ID</th><th class='text-primary'>Age</th>
	<th class='text-primary'>List of What Babies Do At This Age</th>
