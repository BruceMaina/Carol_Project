...
<html>
<head>
<title>Online Milestone Check-list</title>
...
{
	echo "<br><br><h2 class=head1> List of Things Most Children do at this age </h2>";
	exit;
}
echo "<h2 class=head1> Select Milestone </h2>";
