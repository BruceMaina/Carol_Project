...
<html>
<head>
<title>Online Milestone Checklist  - Result </title>
...
{
	echo "<br><br><h1 class=head1> You have not selected the Milestone</h1>";
	exit;
}
echo "<table border=1 align=center><tr class=style2><td width=300>Milestone <td> Total<br> Age <td> Score";
